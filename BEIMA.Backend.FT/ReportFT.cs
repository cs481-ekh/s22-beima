        ...
        public async Task PopulatedDatabase_AllDevicesReport_ReturnsValidZipFileByteArray()
        {
            ...
            using (var zipArchive = new ZipArchive(mem, ZipArchiveMode.Read))
            {
                ...
                using (var streamReader = new StreamReader(entryStream))
                {
                    ...
                    Assert.That(line1, Is.EqualTo("Id,DeviceTypeId,DeviceTag,Manufacturer,ModelNum,SerialNum,YearManufactured,Notes,GenericField,BuildingName,Notes,Latitude,Longitude,Date,User"));
                }
            }
        }
